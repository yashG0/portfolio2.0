                ...
                <div className='grid gap-10 lg:grid-cols-2'>
                ...
                
                    {
                        myServices.map(({id,image,title})=>(
                            <div key={id} className='flex flex-col items-center justify-center p-5 shadow-lg dark:shadow-gray-100 rounded-xl duration-300 ease-in-out hover:scale-110 cursor-pointer hover:shadow-2xl hover:shadow-gray-300 even:hover:translate-x-5 odd:hover:-translate-x-5 hover:dark:bg-gray-800'>
